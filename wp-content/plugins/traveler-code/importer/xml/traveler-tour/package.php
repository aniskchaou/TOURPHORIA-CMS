 ...
 * Time: 9:41 SA
 */
if(!class_exists('ST_Traveler_Tour_Package'))
{
	class ST_Traveler_Tour_Package
	{
		static $_instance;
		...
		function __construct()
		{
			...
			add_filter('st_demo_packages_config_traveler_tour',array($this,'_get_config'));
		}
	...
	ST_Traveler_Tour_Package::instance();
}