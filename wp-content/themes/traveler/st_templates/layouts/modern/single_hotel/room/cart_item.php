        ...
        <ul>
            ...
            <li class="ad-info">
                <ul>
                    ...
                    <li><span class="label"><?php echo __( 'Number of Room', ST_TEXTDOMAIN ); ?></span><span
                            class="value"><?php echo esc_html( $item[ 'number' ] ) . _n( ' Room', ' Rooms', $item[ 'number' ], ST_TEXTDOMAIN ); ?></span>
                    </li>
                    <?php if ( $adult_number ) { ?>
                        <li><span class="label"><?php echo __( 'Number of Adult', ST_TEXTDOMAIN ); ?></span><span
                                class="value"><?php echo $adult_number; ?></span></li>
                    <?php } ?>
                    <?php if ( $child_number ) { ?>
                        <li><span class="label"><?php echo __( 'Number of Children', ST_TEXTDOMAIN ); ?></span><span
