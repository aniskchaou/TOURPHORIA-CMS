    ...
    if ( isset( $item_id ) and $item_id ):
        ...
        <div class="info-section">
            ...
            <span class="label">
                ...
                <?php echo date_i18n( TravelHelper::getDateFormat(), strtotime( $check_in ) ); ?>
                    ...
                    <div class="detail">
                        <button class="btn btn-primary">
                            <?php echo __( 'Detail', ST_TEXTDOMAIN ); ?> <i class="fa fa-caret-down"></i>
                        </button>
                ...
                <li class="ad-info">
                    <ul>
                        <li><span class="label"><?php echo __( 'Stay', ST_TEXTDOMAIN ); ?></span><span class="value">
                        <?php
                            printf( _n( '%d Night', '%d Nights', $date_diff, ST_TEXTDOMAIN ), $date_diff );
                        ?>
                    </span></li>
                        <li><span class="label"><?php echo __( ' Room', ST_TEXTDOMAIN ); ?></span><span
                                    class="value"><?php echo esc_html( $item[ 'number' ] ) . _n( ' Room', ' Rooms', $item[ 'number' ], ST_TEXTDOMAIN ); ?></span>
                        </li>
                        <?php if ( $adult_number ) { ?>
                            <li><span class="label"><?php echo __( 'Adult', ST_TEXTDOMAIN ); ?></span><span
                                        class="value"><?php echo $adult_number; ?></span></li>
                        <?php } ?>
                        <?php if ( $child_number ) { ?>
                            <li><span class="label"><?php echo __( 'Children', ST_TEXTDOMAIN ); ?></span><span
                                        class="value"><?php echo $child_number; ?></span></li>
                        <?php } ?>
                    </ul>
                </li>
                ...
                <?php
                    if ( isset( $item[ 'data' ][ 'deposit_money' ] ) ):
                        ...
                        if ( !empty( $deposit[ 'type' ] ) and !empty( $deposit[ 'amount' ] ) ) {
                            ...
                            <li>
                                <span
                                        class="label"><?php printf( __( 'Deposit %s', ST_TEXTDOMAIN ), $deposit[ 'type' ] ) ?></span>
        ...
        <div class="coupon-section">
            ...
            <form method="post" action="<?php the_permalink() ?>">
                ...
                <div class="form-group">
                    ...
                    <?php } else { ?>
                        <button type="submit"
                                class="btn btn-primary"><?php echo __( 'APPLY', ST_TEXTDOMAIN ); ?></button>
                    <?php } ?>
                </div>
            </form>
        </div>
        <div class="total-section">
            ...
            ?>
            <ul>
                <li><span class="label"><?php echo __( 'Subtotal', ST_TEXTDOMAIN ); ?></span><span
