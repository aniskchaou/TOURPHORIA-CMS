...
<div class="info-section">
    <ul>
        <li><span class="label"><?php echo __('Room', ST_TEXTDOMAIN); ?></span><span class="value"><?php echo get_the_title($room_id)?></span></li>
        <li>
            <span class="label">
        ...
        <li class="ad-info">
            <ul>
                ...
                <li><span class="label"><?php echo __('Number of Room', ST_TEXTDOMAIN); ?></span><span class="value"><?php echo esc_html($item['number']).__(' Room(s)', ST_TEXTDOMAIN);?></span></li>
                <?php if($adult_number) {?>
