                    ...
                    <div class="carousel"
                        ...
                        <?php
                            foreach ( $gallery_array as $value ) {
                                ?>
                                <div class="item" style="background-image: url('<?php echo wp_get_attachment_image_url( $value, 'large' ) ?>')"></div>
                                <?php
                            }
                        ?>
                    </div>
                        ...
                        <div class="col-xs-12 col-md-9">
                            <div class="room-heading">
                                <div class="left">
                                    ...
                                    <div class="sub-heading mt10"><?php echo __( 'Hotel', ST_TEXTDOMAIN ) ?>: <a
