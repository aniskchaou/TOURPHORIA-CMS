                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-9">
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-md-3">
                                        <div class="item has-matchHeight">
                                            ...
                                            <?php echo sprintf( __( 'S: %s', ST_TEXTDOMAIN ), get_post_meta( $room_id, 'room_footage', true ) ) ?>
                                            m<sup>2</sup>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-md-3">
                            ...
                            <div class="st-flex space-between">
                                <h2 class="st-heading-section"><?php echo esc_html__( 'Review', ST_TEXTDOMAIN ); ?></h2>
                            ...
                            <div class="widgets">
                                <div class="fixed-on-mobile" data-screen="992px">
                                    ...
                                    <div class="form-book-wrapper">
                                        ...
                                        <div class="form-head">
                                            <?php echo wp_kses( sprintf( __( 'from <span class="price">%s</span> <span class="unit">/night</span>', ST_TEXTDOMAIN ), TravelHelper::format_money( $sale_price ) ), [ 'span' => [ 'class' => [] ] ] ) ?>
                                        </div>
                                        <?php if(empty($room_external) || $room_external == 'off'){ ?>
                                            <form id="form-booking-inpage single-room-form" class="form single-room-form"
                                                  method="post">
                                                ...
                                                <div class="form-group form-date-field form-date-hotel-room clearfix <?php if ( $has_icon ) echo ' has-icon '; ?>"
                                                    ...
                                                    <div class="date-wrapper clearfix">
                                                        <div class="check-in-wrapper">
                                                            ...
                                                            -
                                                            <div class="render check-out-render"><?php echo $end; ?></div>
                                                        </div>
                                                    </div>
