...
<div class="row st-woo-cartpage">
    <div class="col-md-8 col-left">
        <form action="<?php echo esc_url(wc_get_cart_url()); //echo esc_url( WC()->cart->get_cart_url() ); ?>"
            ...
            ?>
            <h2 class="st-woo-heading"><?php echo __('Cart items', ST_TEXTDOMAIN); ?></h2>
...
', esc_url(wc_get_cart_remove_url($cart_item_key)), __('Remove this item', ST_TEXTDOMAIN)), $cart_item_key);
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        if (isset($cart_item['st_booking_data']) and !empty($cart_item['st_booking_data'])) {
                                            ...
                                            if ($post_type and $booking_id) {
                                                ...
                                                if ($address) {
                                                    echo '<p class="booking-item-address">' . TravelHelper::getNewIcon('Ico_maps', '#666666', '15px', '15px', true) . $address . '</p>';
                                                }
                    ...
                    <td colspan="6" class="actions">
                        ...
                        <?php if (WC()->cart->coupons_enabled()) { ?>
                            <div class="coupon">
                                ...
                                <label for="coupon_code"><?php _e('Coupon', ST_TEXTDOMAIN); ?>:</label> <input
                                        type="text" name="coupon_code" class="input-text" id="coupon_code" value=""
                                        placeholder="<?php _e('Coupon code', ST_TEXTDOMAIN); ?>"/> <input type="submit"
                                                                                                          class="btn btn-primary"
                                                                                                          name="apply_coupon"
                                                                                                          value="<?php _e('Apply Coupon', ST_TEXTDOMAIN); ?>"/>
                        ...
                        <input type="submit" class="btn btn-primary" name="update_cart"
                               value="<?php _e('Update Cart', ST_TEXTDOMAIN); ?>"/>
    ...
    <div class="col-md-4 col-right">
        <h2 class="st-woo-heading"><?php _e( 'Cart totals', ST_TEXTDOMAIN ); ?></h2>
