            ...
            <div class="detail">
                ...
                <?php if ( str_word_count( $content ) >= 80 ) { ?>
                    <a href="#" class="st-link block"
                       ...
                       data-text-less="<?php echo esc_html__( 'Less', ST_TEXTDOMAIN ) ?>"
                       data-text-more="<?php echo esc_html__( 'Read more', ST_TEXTDOMAIN ) ?>">
                        <span class="text"><?php echo esc_html__( 'Read more', ST_TEXTDOMAIN ) ?></span>
