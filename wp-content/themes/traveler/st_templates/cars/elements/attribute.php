...
if(isset( $attr )) {
    ...
    if($taxonomy and taxonomy_exists( $taxonomy )) {
        ...
        if(!empty( $terms )) {
            ...
            <ul class="booking-item-features booking-item-features-expand mb30 clearfix <?php if($taxonomy == 'st_cars_pickup_features')
                echo 'booking-item-features-dark'; ?>">
                <?php
