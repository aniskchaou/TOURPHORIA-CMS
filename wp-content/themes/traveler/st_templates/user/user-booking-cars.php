...
if (STInput::get('scaction') == 'email-notification') {
    ...
    <div class="form-group list-car-type">
        <a href="<?php echo add_query_arg('car_type', 'normal', TravelHelper::get_user_dashboared_link($page_link, 'booking-cars')) ?>" class="<?php if($st_tab=="normal") echo "current"; ?>"><i class="fa fa-car"></i> <?php echo __('Car normal', ST_TEXTDOMAIN); ?></a>&nbsp; &nbsp; &nbsp;
        <a href="<?php echo add_query_arg('car_type', 'transfer', TravelHelper::get_user_dashboared_link($page_link, 'booking-cars')) ?>" class="<?php if($st_tab=="transfer") echo "current"; ?>"><i class="fa fa-tachometer"></i> <?php echo __('Car transfer', ST_TEXTDOMAIN); ?></a>
    </div>
