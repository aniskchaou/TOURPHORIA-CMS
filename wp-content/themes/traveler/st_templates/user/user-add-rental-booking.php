...
?>
<div class="st-create">
    <h2><?php _e("Add New Rental Booking",ST_TEXTDOMAIN) ?></h2>
</div>
	      			...
	      			<div class="row">
	      				<div class="col-xs-12">
	      					<div class="form-group">
						        <label for="rental_id" class="head_bol"><?php _e('Rental', ST_TEXTDOMAIN); ?> <span class="text-small text-danger">(*)</span>:</label>
						        <?php 
			                        $rental_id = isset($_POST['item_id']) ? $_POST['item_id'] : '';
			                        $rental_name = (intval($rental_id) > 0) ? get_the_title($rental_id) : ""; 
			                        
			                    ?>
			                    <input id="rental_id" type="hidden" name="item_id" value="<?php echo $rental_id; ?>" data-post-type="st_rental" class="form-control custom-form-control st_post_select_ajax " data-pl-name="<?php echo $rental_name; ?>" data-user-id="<?php echo get_current_user_id(); ?>">
		      				</div>
	      				</div>
	      			</div>
      				<div class="row">
      					...
      					<div class="col-xs-12 col-sm-6">
      						<div class="form-group">
		      					...
		      					<div class="input-group">
								  	...
								  	<input readonly aria-describedby="basic-checkin" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" autocomplete="off" type="text" name="start" id="check_in" value="<?php echo $check_in; ?>" class="form-control">
								</div>
      					...
      					<div class="col-xs-12 col-sm-6">
      						<div class="form-group">
		      					...
		      					<div class="input-group">
								  	...
								  	<input readonly aria-describedby="basic-checkout" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" autocomplete="off" type="text" name="end" id="check_out" value="<?php echo $check_out; ?>" class="form-control">
							  	</div>
		      				</div>
      					</div>
      				</div>
