...
?>
<div class="st-create">
    <h2><?php _e("Activity Booking", ST_TEXTDOMAIN) ?></h2>
    <?php
    $arr_query_arg = array(
        'sc' => 'booking-activity',
...
if (STInput::get('scaction') == 'email-notification') {
    ...
    <table class="table table-bordered table-striped table-booking-history">
        ...
        <tr>
            ...
            <th><?php _e("Name Activity", ST_TEXTDOMAIN) ?></th>
        ...
        <?php if (!empty($posts)) {
            ...
            foreach ($posts as $key => $value) {
                ...
                <tr>
                    ...
                    <td class="hidden-xs">
                        ...
                        if ($date) echo date('d/m/Y', strtotime($date)); ?><br />
                        <?php echo '<small>' . ($value->starttime == '' ? '' : __('Start Time', ST_TEXTDOMAIN) . ': ' . $value->starttime) . '</small>'; ?>
                    </td>
                    <td> <?php
            ...
            echo '<h5>' . __('No Activity', ST_TEXTDOMAIN) . '</h5>';
        }
        ?>
        </tbody>
    </table>
