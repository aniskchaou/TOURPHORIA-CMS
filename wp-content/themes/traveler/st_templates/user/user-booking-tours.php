...
<div class="st-create">
    ...
    ?>
    <a href="<?php echo add_query_arg($arr_query_arg, get_permalink()); ?>" class="btn btn-primary btn-sm btn-sendmail-notice-link" title="<?php echo __('Send email notification depart date', ST_TEXTDOMAIN); ?>"><?php echo __('Send email notification', ST_TEXTDOMAIN); ?></a>
    <?php } ?>
