...
<div class="form-group form-group-<?php echo esc_attr($field_size)?> form-group-select-plus">
    <label for="field-rental-room-num"><?php echo esc_html($title)?></label>
    ...
    <select id="field-rental-room-num" class="form-control <?php if($old<4)echo 'hidden';?> " name="room_num_search">
        <?php $adult_max=14;
