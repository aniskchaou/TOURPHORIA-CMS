                    ...
                    <?php
                        ...
                        if (class_exists('YITH_WCWL')) {
                            ...
                            <a href="<?php echo esc_url(add_query_arg('add_to_wishlist', get_the_ID(), get_permalink()))?>"
                               rel="tooltip" data-original-title=<?php _e('Add to wishlist', ST_TEXTDOMAIN)?>" class="product-btn product-favorite"><i
                        ...
                        if (class_exists('YITH_Woocompare')) {
                            ...
                            <a href="<?php echo esc_url(add_query_arg(array('iframe' => 'true'), $yith_woocompare->obj->view_table_url())) ?>"
                               rel="tooltip" data-original-title="<?php _e('Compare', ST_TEXTDOMAIN)?>" data-product_id="<?php the_ID()?>"
