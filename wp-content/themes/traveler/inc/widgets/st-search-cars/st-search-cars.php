    ...
    if(!class_exists('st_widget_search_cars')){
        class st_widget_search_cars extends WP_Widget{
            ...
            public function __construct() {
                $widget_ops = array('classname' => 'st_widget_search_cars', 'description' => __( "Cars Filter Box",ST_TEXTDOMAIN) );
                parent::__construct('st_widget_search_cars', __('ST Cars Filter Box',ST_TEXTDOMAIN), $widget_ops);
            ...
            public function form( $instance ) {
                ...
                <div class="st-search-fields">
                    ...
                    <a href="#" class="button st_add_field_cars" onclick="return false;"><?php _e('Add New',ST_TEXTDOMAIN)?></a>
                    <a href="#" class="button st_save_fields_cars" onclick="return false;"><?php _e('Save List',ST_TEXTDOMAIN)?></a>
                </div>
            <?php
            }
        }
