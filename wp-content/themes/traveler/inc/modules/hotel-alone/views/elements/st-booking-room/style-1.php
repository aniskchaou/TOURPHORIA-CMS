...
<div id="st-form-booking-room" class="st-form-booking-room style-1">
    <form class="wpbooking-search-form-wrap wpbooking_order_form form-has-guest-name"  action="<?php echo get_the_permalink(get_the_ID()); ?>">
        ...
        <div class="guest_name_input hidden mb15 mt10" data-placeholder="<?php esc_html_e('Guest %d name',ST_TEXTDOMAIN) ?>" data-hide-children="<?php echo get_post_meta(get_the_ID(),'disable_children_name',true) ?>" data-hide-infant="<?php echo get_post_meta(get_the_ID(),'disable_infant_name',true) ?>">
        ...
        <div class="control">
            <div class="phone">
                ...
                <?php if(!empty($phone)){ ?>
                    <div class="title"><?php esc_html_e("RESERVATION HOTLINE",ST_TEXTDOMAIN) ?></div>
