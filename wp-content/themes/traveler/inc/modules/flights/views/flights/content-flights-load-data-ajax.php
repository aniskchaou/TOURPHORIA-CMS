                ...
                <form class="booking-flight-form" method="post" action="#">
                    ...
                    <div class="your-booking-content">
                        ...
                        if($passenger>1 and $disable_guest_form == 'off'){ ?>
                            <div class="clearfix guest_name_input mb15 mt10" data-placeholder="<?php esc_html_e('Guest %d name',ST_TEXTDOMAIN) ?>" data-hide-children="<?php echo get_post_meta(get_the_ID(),'disable_children_name',true) ?>" data-hide-infant="<?php echo get_post_meta(get_the_ID(),'disable_infant_name',true) ?>">
                        ...
                        <div class="st-book-now">
                            ...
                            <!--<button class="btn btn-default btn-send-message" data-id=""><?php /*echo __( 'Send message', ST_TEXTDOMAIN ); */?></button>-->
                        </div>
                    </div>
                </form>
            </div>
