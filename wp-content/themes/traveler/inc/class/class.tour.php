        ...
        class STTour extends TravelerObject
        {
            ...
            public function st_filter_tour_ajax()
            {
	            ...
	            if (have_posts()) {
                    ...
                    echo '<h3 class="ajax-filter-not-found">'. __('No tours found', ST_TEXTDOMAIN) .'</h3>';
                }
            ...
            function get_result_string()
            {
                ...
                if ( $query->found_posts ) {
                    if ( $query->found_posts > 1 ) {
                        $p1 .= esc_html( $query->found_posts ) . __( ' tours ', ST_TEXTDOMAIN );
                    } else {
                        $p1 .= esc_html( $query->found_posts ) . __( ' tour ', ST_TEXTDOMAIN );
                    }
                } else {
                    $p1 = __( 'No tour found', ST_TEXTDOMAIN );
                }
