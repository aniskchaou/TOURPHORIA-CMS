			...
			self.calendar.fullCalendar({
				...
				eventClick: function(event, element, view){
                    ...
                    if(price_type == 'person') {
                        ...
                        $('#calendar_base_price', self.form_container).val(event.base_price);
					}
				...
				eventRender: function(event, element, view){
					...
					if(event.status == 'available'){
						...
						if(price_type == 'person') {
                            if (hide_adult != 'on') {
                                html += '<div class="price">' + st_params.text_adult + event.adult_price + '</div>';
                            }
                            if (hide_children != 'on') {
                                html += '<div class="price">' + st_params.text_child + event.child_price + '</div>';
                            }
                            if (hide_infant != 'on') {
                                html += '<div class="price">' + st_params.text_infant + event.infant_price + '</div>';
                            }
                        }else{
                            html += '<div class="price">' + st_params.text_price + event.base_price + '</div>';
						}
                        if(event.starttime != '' && event.starttime != null) {
