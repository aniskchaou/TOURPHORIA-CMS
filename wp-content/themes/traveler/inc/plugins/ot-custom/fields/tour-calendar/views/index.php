        ...
        <div class="calendar-form">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6 col-lg-4 hide">
                    <div class="form-group">
                        <label for="calendar_base_price"><?php echo __('Price', ST_TEXTDOMAIN); ?></label>
                        <input type="text" name="calendar_base_price" id="calendar_base_price" class="form-control" placeholder="<?php echo __('Base price', ST_TEXTDOMAIN); ?>">
                    </div>
                </div>
