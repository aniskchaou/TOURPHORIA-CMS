                    ...
                    <div id="poststuff">
                        <div class="postbox">
                            ...
                            <div class="inside">
                                ...
                                <div class="form-row">
                                    <label class="form-label" for=""><?php _e('Hotel',ST_TEXTDOMAIN)?></label>
                                    <div class="controls">
                                ...
                                <div class="form-row">
                                    <label class="form-label" for=""><?php _e('No. Children',ST_TEXTDOMAIN)?></label>
                                    <div class="controls">
                                            ...
                                            <table class="table" style="table-layout: fixed;" width="200">
                                                ...
                                                <tr>
                                                    <td width="80%">
                                                        ...
                                                        <strong><?php echo $val['title']; ?></label></strong>
                                                    </td>
                                                    <td width="20%">
                                                        <strong><?php echo $data_number[$val['extra_name']]; ?></strong>
                                                    </td>
                                                </tr>
                                                <?php endforeach; ?>
                                            </table>
