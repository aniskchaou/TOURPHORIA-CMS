<?php
    ...
    echo '<h2>' . __( 'Activity Booking', ST_TEXTDOMAIN ) . '</h2>';
...
<form id="posts-filter" action="<?php echo admin_url( 'edit.php?post_type=st_activity&page=st_activity_booking' ) ?>"
    ...
    <table class="wp-list-table widefat fixed posts">
        ...
        <tr>
            ...
            <th class="manage-column" width="10%">
                <a href="#"><span><?php _e( 'Check Out', ST_TEXTDOMAIN ) ?></span><span
                        class="sorting-indicator"></span></a>
            </th>
            <th class="manage-column">
                <a href="#"><span><?php _e( 'Activity Name', ST_TEXTDOMAIN ) ?></span><span
                        class="sorting-indicator"></span></a>
            </th>
                    ...
                    <tr class="<?php if ( $i % 2 == 0 ) echo 'alternate'; ?>">
                        ...
                        <td class="post-title page-title column-title">
                            ...
                            <div class="row-actions">
                                <a href="<?php echo admin_url( 'edit.php?post_type=st_activity&page=st_activity_booking&section=edit_order_item&order_item_id=' . $post_id ); ?>"><?php _e( 'Edit', ST_TEXTDOMAIN ) ?></a>
                                |
                                <a href="<?php echo admin_url( 'edit.php?post_type=st_activity&page=st_activity_booking&section=resend_email_activity&order_item_id=' . $post_id ); ?>"><?php _e( 'Resend Email', ST_TEXTDOMAIN ) ?></a>
