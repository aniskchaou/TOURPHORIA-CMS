                    ...
                    <div id="poststuff">
                        <div class="postbox">
                            ...
                            <div class="inside">
                                ...
                                <div class="form-row">
                                    <label class="form-label" for=""><?php _e( 'Rental', ST_TEXTDOMAIN ) ?></label>
                                    <div class="controls">
                                        <?php
                                                    ...
                                                    <tr>
                                                        <td width="80%">
                                                            <label for="<?php echo $val[ 'extra_name' ]; ?>"
                                                                   class="ml20">
                                                                <strong><?php echo $val[ 'title' ] . '(' . TravelHelper::format_money_from_db( $val[ 'extra_price' ], $currency ) . ')'; ?></strong>
                                                            </label>
                                                        </td>
                                                        <td width="20%">
