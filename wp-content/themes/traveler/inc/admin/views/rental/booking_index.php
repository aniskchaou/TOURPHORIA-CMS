...
echo '<h2>'.__('Rental Booking',ST_TEXTDOMAIN).'</h2>';
    ...
    <table class="wp-list-table widefat fixed posts">
        <thead>
            <tr>
                ...
                <th class="manage-column">
                    <a href="#"><span><?php _e('Rental Name',ST_TEXTDOMAIN)?></span><span class="sorting-indicator"></span></a>
                </th>
                        ...
                        <tr class="<?php if ($i % 2 == 0) echo 'alternate'; ?>">
                            ...
                            <td class="post-title page-title column-title">
                                ...
                                <div class="row-actions">
                                    <a href="<?php echo admin_url('edit.php?post_type=st_rental&page=st_rental_booking&section=edit_order_item&order_item_id=' . $post_id); ?>"><?php _e('Edit',ST_TEXTDOMAIN)?></a> |
                                    <a href="<?php echo admin_url('edit.php?post_type=st_rental&page=st_rental_booking&section=resend_email&order_item_id=' . $post_id); ?>"><?php _e('Resend Email',ST_TEXTDOMAIN)?></a>
