                    ...
                    <div id="poststuff">
                        <div class="postbox">
                            ...
                            <div class="inside">
                                ...
                                <div class="form-row">
                                    <label class="form-label"
                                           for=""><?php _e( 'Tour Type', ST_TEXTDOMAIN ) ?></label>
                                    <div class="controls">
                                        <?php
                                        ...
                                        ?>
                                        <strong><?php echo $tour_name; ?></strong>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <label class="form-label"
                                ...
                                <div class="form-row">
                                    <label class="form-label"
                                           for="check_in"><?php _e( 'Departure date', ST_TEXTDOMAIN ) ?></label>
                                    <div class="controls">
                                        <?php
                                ...
                                <div class="form-row <?php if ( $tour_type == 'daily_tour' ) echo 'hide'; ?>">
                                    <label class="form-label"
                                           for="check_out"><?php _e( 'Return date', ST_TEXTDOMAIN ) ?></label>
                                    <div class="controls">
                                        <?php
                                ...
                                <div class="form-row">
                                    <label class="form-label"
                                           for="max_people"><?php _e( 'Start Time', ST_TEXTDOMAIN ) ?></label>
                                    <div class="controls">
                                        <?php
                                ...
                                <?php if ( $tour_type == 'daily_tour' ): ?>
                                    <div class="form-row">
                                        <label class="form-label"
                                               for="duration"><?php _e( 'Duration', ST_TEXTDOMAIN ) ?> </label>
                                        <div class="controls">
                                            <?php
                                ...
                                <div class="form-row">
                                    <label class="form-label"
                                           for=""><?php _e( 'No. Adults', ST_TEXTDOMAIN ) ?></label>
                                    <div class="controls">
                                        <?php
                                ...
                                <div class="form-row">
                                    <label class="form-label"
                                           for=""><?php _e( 'No. Infant', ST_TEXTDOMAIN ) ?></label>
                                    <div class="controls">
                                        <?php
                                ...
                                <div class="form-row">
                                    <label class="form-label"
                                           for=""><?php _e( 'Adult Price', ST_TEXTDOMAIN ) ?></label>
                                    <div class="controls">
                                        <?php
                                ...
                                <div class="form-row">
                                    <label class="form-label"
                                           for=""><?php _e( 'Children Price', ST_TEXTDOMAIN ) ?></label>
                                    <div class="controls">
                                        <?php
                                ...
                                <div class="form-row">
                                    <label class="form-label"
                                           for=""><?php _e( 'Infant Price', ST_TEXTDOMAIN ) ?></label>
                                    <div class="controls">
                                        <?php
