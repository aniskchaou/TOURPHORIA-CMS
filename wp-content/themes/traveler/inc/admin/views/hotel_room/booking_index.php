...
echo '<h2>'.__('Room Bookings',ST_TEXTDOMAIN).'</h2>';
                        ...
                        <tr class="<?php if ($i % 2 == 0) echo 'alternate'; ?>">
                            ...
                            <td class="post-title page-title column-title">
                                ...
                                <div class="row-actions">
                                    <a href="<?php echo admin_url('edit.php?post_type=hotel_room&page=st_hotel_room_booking&section=edit_order_item&order_item_id=' . $post_id); ?>"><?php _e('Edit',ST_TEXTDOMAIN)?></a> |
                                    <a href="<?php echo admin_url('edit.php?post_type=hotel_room&page=st_hotel_room_booking&section=resend_email&order_item_id=' . $post_id); ?>"><?php _e('Resend Email',ST_TEXTDOMAIN)?></a>
